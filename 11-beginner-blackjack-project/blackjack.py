...
def play_game():
    ...
    while not is_game_over:
        ...
        print(f"  Your final hand was: {user_cards}, and final score was: {user_score}")
        print(f"  Computer's final hand was: {computer_cards}, and final score was: {computer_score}")
